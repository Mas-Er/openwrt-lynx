...
[<img alt="GitHub Workflow Status" src="https://img.shields.io/github/actions/workflow/status/lynxnexy/openwrt/build-openwrt.yml?branch=main">](https://github.com/lynxnexy/openwrt/actions/workflows/build-openwrt.yml) [<img alt="GitHub commit activity" src="https://img.shields.io/github/commit-activity/m/lynxnexy/openwrt?label=commits">](https://github.com/lynxnexy/openwrt/commits) [<img alt="Donate" src="https://img.shields.io/badge/_-donate-orange.svg?logo=githubsponsors&labelColor=555555&style=flat">](https://trakteer.id/lynxnexy/tip) </br>
